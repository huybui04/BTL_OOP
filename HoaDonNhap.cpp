...
//
//HoaDonNhap::HoaDonNhap(std::string maHDN, std::string ngayNhap, const NhanVien &nhanVien, const NhaCungCap &nhaCungCap)
...
//}
//
//void HoaDonNhap::setNhanVien(const NhanVien &nhanVien) {
//    nv = nhanVien;
//}
//
//NhanVien HoaDonNhap::getNhanVien() const {
//    return nv;
//}
//
//void HoaDonNhap::setNhaCungCap(const NhaCungCap &nhaCungCap) {
//    ncc = nhaCungCap;
//}
//
//NhaCungCap HoaDonNhap::getNhaCungCap() const {
//    return ncc;
//}
//
...
//    double tongTien = 0.0;
//    for (auto ct : dsCTHDN) {
//        if (ct.getHDN().getMaHDN() == this->MaHDN)
...
//    std::cout << "Nha Cung Cap: " << ncc.getTenNCC() << std::endl;
