...
//    HoaDonBan(const std::string &maHDB, const std::string &ngayBan, const NhanVien &nhanVien, const KhachHang &khachHang, const Ban &ban, const std::vector<ChiTietHoaDonBan> &dscthdb);
//
...
//    void setKhachHang(const KhachHang &khachHang);
//    KhachHang getKhachHang() const;
//    void setBan(const Ban &ban);
//    Ban getBan() const;
